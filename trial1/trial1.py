...
class Node2Vec():
        ...
        def second_order_biased_random_walk(
                ...
                #     print("Doing generation of node ", i, " of walk ", start_node, file=sys.stdout)
...
#     print(adjacency_list[100][0], adjacency_list[100][1])
    ...
    dw = Node2Vec(adjacency_list, 10, 128, 80, 40, 0.25, 0.25)
    ...
    dw.model.wv.save_word2vec_format('pos.txt')
